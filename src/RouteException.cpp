...
// RouteException.cpp
//
// $Id: //ecodtn/0.1/QualityManager/src/RouteException.cpp#1 $
//
...
RouteException::RouteException(const std::string& msg, int code): 
	Poco::Exception(std::string("[RouteManager]: ") + msg, code)
{
}


RouteException::RouteException(const RouteException& exc): 
	Poco::Exception(exc)
{
}
