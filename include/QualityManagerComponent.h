...
/*!  \file   QualityManagerComponent.h
...
#ifndef _QUALITYMANAGERCOMPONENT_H_
#define _QUALITYMANAGERCOMPONENT_H_
...
typedef map<fd_t, QualityManagerComponent*,ltfd>            fdList_t;
typedef map<fd_t, QualityManagerComponent*,ltfd>::iterator  fdListIter_t;
...
class QualityManagerComponent
{
  ...
  public:
    ...
    /*!  \brief  construct a new QualityManagerComponent base
    ...
    */
    QualityManagerComponent(ConfigManager *_cnf, string name, int thread=0 );

    //! destroy Quality Manager component, to be overloaded
    virtual ~QualityManagerComponent();
...
#endif // _QUALITYMANAGERCOMPONENT_H_
